...
function Landing() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Savings Goals',
      desc: 'Set goals for a new car or vacation. Track your progress visually as you save up.'
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      desc: 'Automatically track and deduct your monthly Netflix, Rent, and EMI payments.'
    }
  ]

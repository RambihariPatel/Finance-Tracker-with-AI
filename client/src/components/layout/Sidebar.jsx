...
function Sidebar({ onClose }) {
  ...
  const navItems = [
    ...
    { label: 'Subscriptions', path: '/subscriptions', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
    { label: 'AI Insights', path: '/insights', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    { label: 'Goals', path: '/goals', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    { label: 'Group Splitter', path: '/groups', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
